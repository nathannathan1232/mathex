...
;(function (globalScope) {
  ...
  P.bitShift = function (y) {
    var n = this;

    var m = new Decimal(2).pow(y);

    return n.times(m);
  }

  P.bitUnShift = function (y) {
    var n = this;

    var m = new Decimal(2).pow(y);

    return n.dividedBy(m);
  }
  ...
  P.toFixed = function (dp, rm) {
    ...
    // If dp is a Decimal object, convert to number
    if(typeof dp === 'object')
      dp = Number(dp + '')
